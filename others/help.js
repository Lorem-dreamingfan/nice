...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    .addField("• Developer", `\`\`\`yml\nName: lorem(dreamingfan) [889074547398156299]\nName Ξ lorem(crow, dreamingfan) [889074547398156299]\`\`\``)
    .addField("• Important Links", `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support Server](https://discord.gg/WhdKYPzeVb)\`|\`[Instagram](https://instagram.com/darshan_12350)\`**`)
